...
- (void)backView {
    ...
    UIImageView *codeImageView = [[UIImageView alloc] initWithFrame:CGRectMake((RPWidth - 200)/2, 100, 200, 200)];
    ...
    //有图片的时候，也可以不设置圆角
    [codeImageView creatCode:@"https://gongyuhonglou.github.io" Image:[UIImage imageNamed:@"fox.jpg"] andImageCorner:4];
